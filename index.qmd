...
[This article describes PCA’s usefulness in data science and in dealing with large datasets and from there gives a basic description of the methods involved in PCA followed by an example. The article then proceeds to discuss some issues related to PCA while providing plots and visuals and then examines some adaptations of PCA with examples included.]style="color: #8B814C;"}
